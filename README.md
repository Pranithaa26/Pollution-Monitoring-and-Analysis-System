...
- River network
- Centerline
- Towns and headquarters

Users can zoom, pan, and click features to view details.
...
2. Backend processes raster using raster_clip.py
3. Clipped raster (precip_clipped.tif) is generated
4. Raster is displayed on the map
...
- Performs river and climate analysis
